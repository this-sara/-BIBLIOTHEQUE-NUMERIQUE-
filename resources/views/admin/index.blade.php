			...
			<div class="content container-fluid">
						...
						<div class="card board1 fill">
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										<h3 class="card_widget_header">{{$livres}}</h3>
										<h6 class="text-muted">Total Books</h6> </div>
					...
					<div class="col-xl-3 col-sm-6 col-12">
						<div class="card board1 fill">
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										<h3 class="card_widget_header">{{$livres-1}}</h3>
										<h6 class="text-muted">Available books</h6> </div>
					...
					<div class="col-xl-3 col-sm-6 col-12">
						<div class="card board1 fill">
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										<h3 class="card_widget_header">{{$emprunts}}</h3>
				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-6">
						<div class="card card-chart">
							<div class="card-header">
								<h4 class="card-title">BOOKS BOOKED</h4> </div>
							<div class="card-body">
