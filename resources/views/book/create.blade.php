				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							...
							<h3 class="page-title mt-5">Add Book</h3> 
						</div>
					</div>
						...
						<form action="{{route('books.store')}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row formtype">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label>editeur</label>
										<input class="form-control" type="text" value="" name="editeur"> 
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="number" name="nbre_exemplaires" value=""> 
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
